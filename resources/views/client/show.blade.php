        ...
        <div class="grid lg:grid-cols-2 gap-8 max-lg:max-w-2xl mx-auto">
          <div class="text-left">
            ...
            <div class="grid xl:grid-cols-3 sm:grid-cols-2 gap-8 mt-12">
              ...
              <div class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="_x32_" viewBox="0 0 512 512" xml:space="preserve">
                  <style type="text/css">
                    .st0{fill:#000000;}
                  </style>
                  <g>
                ...
                <h6 class="text-base font-semibold ml-4">{{ \Carbon\Carbon::parse($event->date)->formatLocalized('%d %B %Y') }}</h6>
              </div>
              <div class="flex items-center">
