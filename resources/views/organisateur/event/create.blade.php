<x-organiser-dashboard>
    ...
    @if (session()->has('message'))
        ...
        @endpush
    @endif
    <form class="p-4 md:p-5" method="post" action="{{ route('event.store') }} "
                    ...
                    <div class="grid gap-6 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            <label for="placesdisponible" class="block mb-2 text-sm font-medium text-gray-900">Event
                                places</label>
                            <input type="number" name="placesdisponible" id="placesdisponible"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                placeholder="number of place" required="">
                        </div>
                        <div class="col-span-2">
                            <label for="category" class="block mb-2 text-sm font-medium text-gray-900">Validate</label>
